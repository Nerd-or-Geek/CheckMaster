...
export default function FoldersScreen() {
  const {
    settings, isDark, folders, checklists,
  ...
  const confirmDeleteFolder = (folder: { id: string; name: string }) => {
    Alert.alert(
      'Delete folder?',
      `"${folder.name}" and everything inside it will be permanently removed.`,
      [
  ...
  const confirmDeleteChecklist = (cl: Checklist) => {
    Alert.alert(
      'Delete checklist?',
      `Remove "${cl.name}" and all of its items?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Delete',
        ...
        {currentFolderId ? (
          <View style={styles.section}>
            <View style={styles.sectionHeaderRow}>
              <Text style={[styles.sectionLabel, { color: theme.textTertiary }]}>CHECKLISTS</Text>
        ...
        <View style={[styles.modalOverlay, { backgroundColor: theme.overlay }]}>
          <View style={[styles.modal, { backgroundColor: theme.surface, paddingBottom: insets.bottom + 16 }]}>
            ...
            <View style={{ paddingHorizontal: 20 }}>
              <Text style={[styles.inputLabel, { color: theme.textTertiary }]}>FOLDER NAME</Text>
              <TextInput
                ...
                autoFocus
              />
              <Text style={[styles.inputLabel, { color: theme.textTertiary }]}>COLOR</Text>
          ...
          <View style={[styles.modal, { backgroundColor: theme.surface, paddingBottom: insets.bottom + 16 }]}>
            ...
            <View style={{ paddingHorizontal: 20 }}>
              <Text style={{ color: theme.textSecondary, fontSize: 14, lineHeight: 20, marginBottom: 12 }}>
                Paste the entire message you received (including the CHECKMASTER markers). The checklist will be added to this folder.
              </Text>
              <TextInput
                ...
                placeholder="Paste shared checklist here..."
                placeholderTextColor={theme.textTertiary}
                multiline
        ...
        <View style={[styles.modalOverlay, { backgroundColor: theme.overlay }]}>
          <View style={[styles.modal, { backgroundColor: theme.surface, paddingBottom: insets.bottom + 16 }]}>
            ...
            <ScrollView style={{ paddingHorizontal: 20 }} showsVerticalScrollIndicator={false}>
              <Text style={[styles.inputLabel, { color: theme.textTertiary }]}>NAME</Text>
              <TextInput
                style={[styles.input, { backgroundColor: theme.backgroundSecondary, color: theme.textPrimary, borderColor: theme.border }]}
                ...
                autoFocus
              />
              <Text style={[styles.inputLabel, { color: theme.textTertiary }]}>DESCRIPTION</Text>
              <TextInput
                style={[styles.input, { backgroundColor: theme.backgroundSecondary, color: theme.textPrimary, borderColor: theme.border }]}
                ...
                placeholderTextColor={theme.textTertiary}
              />
              <Text style={[styles.inputLabel, { color: theme.textTertiary }]}>TYPE</Text>
...
const styles = StyleSheet.create({
  ...
  inputLabel: { fontSize: 11, fontWeight: '700', letterSpacing: 0.5, marginBottom: 6, textTransform: 'uppercase' },
  input: {
